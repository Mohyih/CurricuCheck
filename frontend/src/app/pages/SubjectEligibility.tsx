...
<span className="text-sm font-bold text-orange-700">
  ...
  className="w-[190px] sm:w-auto px-6 sm:px-8 py-3 sm:py-3.5 rounded-full bg-gradient-to-r from-[#085830] to-[#A8C957] text-white text-sm sm:text-base font-bold text-center shadow-md hover:shadow-lg transition-all transform hover:-translate-y-0.5"
>
