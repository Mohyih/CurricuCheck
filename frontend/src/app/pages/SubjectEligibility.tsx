        ...
        <div className="flex flex-wrap gap-4 mb-6">
          <div className="bg-white px-5 py-3 rounded-xl border border-[#C8E6D4]/50 shadow-[0_4px_20px_rgb(0,0,0,0.02)] flex items-center gap-3">
            ...
            <span className="font-semibold text-gray-600 text-sm">
              Eligible Subject/s: <span className="text-green-600 font-bold ml-1">{data.eligible.length}</span>
            </span>
          </div>
          <div className="bg-white px-5 py-3 rounded-xl border border-[#C8E6D4]/50 shadow-[0_4px_20px_rgb(0,0,0,0.02)] flex items-center gap-3">
            <div className="w-2.5 h-2.5 rounded-full bg-red-500 shadow-sm"></div>
            <span className="font-semibold text-gray-600 text-sm">
              Blocked Subject/s: <span className="text-red-600 font-bold ml-1">{data.blocked.length}</span>
            </span>
          </div>
          <div className="bg-white px-5 py-3 rounded-xl border border-[#C8E6D4]/50 shadow-[0_4px_20px_rgb(0,0,0,0.02)] flex items-center gap-3">
            <div className="w-2.5 h-2.5 rounded-full bg-orange-400 shadow-sm"></div>
            <span className="font-semibold text-gray-600 text-sm">
              Deferred Subject/s: <span className="text-orange-500 font-bold ml-1">{data.deferred.length}</span>
            </span>
          </div>
          {data.retakes.length > 0 && (
            <div className="bg-white px-5 py-3 rounded-xl border border-[#C8E6D4]/50 shadow-[0_4px_20px_rgb(0,0,0,0.02)] flex items-center gap-3">
              ...
              <span className="font-semibold text-gray-600 text-sm">
                Retake Subject/s: <span className="text-purple-600 font-bold ml-1">{data.retakes.length}</span>
              </span>
            </div>
          )}
        </div>
