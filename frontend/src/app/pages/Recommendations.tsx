  ...
  return (
    <Layout>
      <div className="max-w-[1000px] mx-auto">
        ...
        <div className="mb-10 px-3 md:px-0">
          ...
          <div className="md:hidden flex items-center justify-center gap-3">
            <div className="flex flex-col items-center gap-1">
              ...
              <span className="text-xs font-bold text-[#136537]">Rec</span>
            </div>
            ...
            <div className="w-3 h-0.5 bg-indigo-200"></div>
            <div className="flex flex-col items-center gap-1">
              <div className="w-5 h-5 rounded-full bg-[#136537]"></div>
              <span className="text-xs font-bold text-[#136537]">Pick</span>
            </div>
          </div>
        </div>
        ...
        {/* Table */}
        <div className="bg-white rounded-[1.25rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-[#C8E6D4]/50 overflow-hidden mb-6 mx-3 md:mx-0">
            ...
            <table className="w-full text-left text-sm">
              <thead>
                <tr className="text-gray-500 border-b border-gray-100 bg-gray-50/30">
                  ...
                  <th className="px-2 md:px-6 py-3 md:py-4 font-medium text-xs md:text-sm text-center">Priority</th>
                  <th className="px-2 md:px-6 py-3 md:py-4 font-medium text-xs md:text-sm text-center">Select</th>
                </tr>
              </thead>
                      ...
                      <td className="px-2 md:px-6 py-2 md:py-4 text-gray-600 text-xs md:text-sm">
                        <div className="line-clamp-2">
                          ...
                          {subject.subject_type === 'nstp' && (
                            <span className="block text-xs text-[#F2AB50]">(0 units)</span>
                          )}
                        </div>
                      </td>
